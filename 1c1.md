...
`old password,New password and confirm password fileds should be marked with asterisk  symbol`
...
`User should get confirmation message as "we have succesfully changed your password"`
...
## Verify the cancel button funcitoanlity with filling all mandatory fields
1. Open {{ENV}}.qa.solvexia.com
2. login to the application with valid credentials
3. go to profile --> SolveXia Account and click on Change password button at top the screen 
4. Enter valid Old  password,
...
## Verify user able to change password by giving invalid data in all mandatory fields 
1. Open {{ENV}}.qa.solvexia.com
2. login to the application with valid credentials
3. go to profile --> SolveXia Account and click on Change password button at top the screen 
...
`User should get warning message as "Passwords do not match`

## Verify by Change password by not filling one mandatory field 
1. Open {{ENV}}.qa.solvexia.com
2. login to the application with valid credentials
3. go to profile --> SolveXia Account and click on Change password button at top the screen 
...
`User should get warning message as "Either the old password or new password were not supplied"`
...
## Verify the Password Criteria by giving valid criteria 
1. Open {{ENV}}.qa.solvexia.com
2. login to the application with valid credentials
3. go to profile --> SolveXia Account
